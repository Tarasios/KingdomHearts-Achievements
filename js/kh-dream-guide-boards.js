/* =====================================================================
   ...
   To FIX a board:
     ...
     3. Each board has EXACTLY ONE start — the gold keyhole node. It lives
        in `starts["<Spirit>"]` as a single coord; trails flow outward from
        it. A board must never have more than one start.
   See docs/ability-board-review.md for which boards still need a pass.
   Source: starts + paths reconciled against the authoritative
           ability_link_boards.json grids; trails re-rooted from each
           board's true start node.
   ===================================================================== */
window.DG_BOARDS = {
  "boards": {
  "Aura Lion": [
